...
export const ELEVEN_VOICE_SETTINGS=Object.freeze({stability:.45,similarity_boost:.75,style:.12,use_speaker_boost:true,speed:.98});
...
export function slotBrief(item,plan) {
  const briefs={
    useful:'Ранковий актуальний Reel для Facebook: новина моди, практична порада про одяг або коротка порада зі стилю за topic. Гачок, суть, практичний приклад, висновок: рівно чотири сцени, 40–60 слів сумарно. Текст кожної сцени буде показано у відео. Для новини потрібні свіжі перевірені джерела. Немає продажу.',
    product:'Презентація товару дня у вертикальній каруселі Facebook 9:16. Caption окремий від вечірнього Reel. Дай рівно чотири короткі lines по 2–6 слів для написів безпосередньо на фото: назва речі / видима деталь / спосіб носіння / звернення щодо наявності. Вибери до шести різних оригінальних фото: загальний вигляд, інший ракурс, ближчий кадр, решта. Не переповідай ранкову пораду.',
    ...
    sale:'Вечірній продажний Reel Facebook БЕЗ ОЗВУЧКИ про той самий товар дня. Рівно чотири lines — короткі написи-підказки по 2–6 слів, до 40 символів кожен: конкретна річ / видима деталь / варіант носіння / звернення для замовлення. Caption має бути повністю іншим за карусель: інший гачок, ритм і заклик. Жодних тверджень про комфорт, склад чи посадку, яких немає в даних. Вибери чотири різні оригінальні ракурси, за наявності відео віддай йому перевагу.',
